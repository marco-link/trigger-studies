...
# load data
data = modules.dataModule.loadData('JetHT')
...
# define datasets
full = {'data': data, 'label': 'JetHT', 'key': 'dataset', 'sets': ['JetHT-postfix'], 'denom': 'PFHT430_OR_PFHT780_OR_PFJet500'}
data['dataset'] = data['dataset'].mask(data['run'].values > 299504, other='JetHT-postfix')

menu = {'data': data, 'label': 'JetHT', 'key': 'menu', 'sets': ['menu_2017_v1', 'menu_2017_v2', 'menu_2017_v3'], 'denom': 'PFHT430_OR_PFHT780_OR_PFJet500'}
...
runs = {'data': data, 'label': 'JetHT', 'key': 'runs', 'sets': ['RunB', 'RunC', 'RunD'], 'denom': 'PFHT430_OR_PFHT780_OR_PFJet500'}
...
#modules.triggerplotModule.write2tex('\section{JetHT}\n', texpath=texfile)
...
modules.triggerplotModule.do2DPlot(full, 'OR_all_trigger', phi1, eta1, texpath=texfile, mask='Mjj>1200GeV')
modules.triggerplotModule.do2DPlot(full, 'OR_all_trigger', phi1, eta1, texpath=texfile)